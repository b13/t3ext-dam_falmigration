...
if (TYPO3_MODE == 'BE') {
	$TYPO3_CONF_VARS['SC_OPTIONS']['scheduler']['tasks']['tx_damfalmigration_task_migratetask'] = array(
		'extension'        => $_EXTKEY,
	...
	$TYPO3_CONF_VARS['SC_OPTIONS']['scheduler']['tasks']['tx_damfalmigration_task_migraterelationstask'] = array(
		'extension'        => $_EXTKEY,
